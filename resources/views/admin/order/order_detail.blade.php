                ...
                <tbody>
                    @foreach ($order_details as $key=>$val)
                        <tr>
                            ...
                            <td>{{ $val->price }} MMK</td>
                            <td>{{ $val->quantity }}</td>
                            <td>{{ $val->quantity * $val->price }} MMK</td>
                            <td>
                              
                                @if ($val->is_send == 0)
                                    <a href="/admin/order/status/{{ $val->id }}" class="btn btn-sm btn-danger">
                                        <i class="feather-minus-circle"></i> Not yet Sent
                                    </a>
                                @else
                                    <a href="/admin/order/status/{{ $val->id }}" class="btn btn-sm btn-success">
