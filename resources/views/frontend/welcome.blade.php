                                ...
                                <div class="card shadow">
                                    <div class="card-body p-5">
                                        ...
                                        <p class="mb-0 d-flex justify-content-between">
                                            <span
                                                class="badge badge-danger "><strong>{{ $item->price }}</strong>KS</span>
                        ...
                        @foreach ($product as $item)
                            <div class="col-lg-3 col-md-6 col-12 mb-5">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <p class="text-center">
                                            <img src="{{ $item->image }}" width="150" height="130"
                                                alt="{{ $item->name }}">
                                        </p>

                                    </div>
                                    <div class="card-footer d-flex justify-content-between">
                                        <a href="product/{{ $item->id }}/detail" class="btn btn-primary btn-sm"><i class="feather-eye"></i></a>
                                        <span><strong class="text-info">{{ $item->price }}</strong> MMK</span>
                                        <span onclick="addCart({{ $item->id }})" class="btn btn-primary btn-sm"><i
