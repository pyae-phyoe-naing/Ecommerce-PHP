                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="/user/register" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <small
                                    class="text text-danger"><strong><?php echo e(App\Classes\Session::error('confirm_password')); ?></strong></small>
...
<?php /**PATH C:\xampp\htdocs\PHP-Ecommerce\resources\views/frontend/user_register.blade.php ENDPATH**/ ?>